...
&nbsp;
  Object.keys(env).forEach(key =&gt; {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (env[key]) {
      ...
      if (envOptions.assignToProcessEnv === true) {
        if (envOptions.overrideProcessEnv === true) {
          ...
          process.env[key] = process.env[key] || <span class="branch-1 cbranch-no" title="branch not covered" >env[key];</span>
        }
      }
    }
  });
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon May 04 2020 07:01:30 GMT-0500 (Central Daylight Time)
</div>
</div>
